...
import TreatmentLine from './ui/TreatmentLine';
              ...
              return (
                ...
                >
                  ...
                  <div className="relative mb-6">
                    ...
                    {/* Pulse Glow */}
                    <div className="absolute inset-0 rounded-full bg-secondary/5 blur-md scale-75 opacity-0 group-hover:opacity-100 group-hover:scale-125 transition-all duration-500 z-0 pointer-events-none" />
                  </div>
